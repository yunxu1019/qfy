 ...
 * UEditor Mini版本
 * version: 1.2.2
 * build: Tue Mar 24 2020 23:45:10 GMT+0800 (GMT+08:00)
 */
    ...
    */
    ...
    UM.plugins['autoupload'] = function () {
        ...
        var sendAndInsertImage = function (file, editor) {
            //模拟数据
            var uploadto = me.options.imageUrl;
    ...
    UM.registerUI('autofloat', function () {
        ...
        var optsAutoFloatEnabled = me.options.autoFloatEnabled !== false,
            topOffset = modules.getScreenPosition(me.container.offsetParent).top;
        ...
        me.ready(function () {
            ...
            function setFloating() {
                ...
                if (LteIE6 || (quirks && browser.ie)) {
                    ...
                    if (toolbarBox.style.position != 'fixed') {
                        ...
                        toolbarBox.style.top = modules.fromOffset(topOffset);
            ...
            if (checkHasUI(me)) {
                ...
                $(me.container.offsetParent).on('scroll', updateFloating);
